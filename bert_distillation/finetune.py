...
class Config(NamedTuple):
    ...
    model_file: str = "/home/shivam/Desktop/bert_distillation/models/ether/classifier/model_steps_9500.pt"
    pretrain_file: str = "uncased_L-12_H-768_A-12/bert_model.ckpt"
    save_dir: str = "exp"
    comment: str = [] # for comments in json file


def main():
    sent_1 = 'This is distillation test'
    sent_2 = "If test successful, it can make language model faster"
    instance = "0" ,sent_1,sent_2
